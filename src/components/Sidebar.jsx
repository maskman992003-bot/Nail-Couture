...
const navItemsByRole = {
  super_admin: [
    ...
    { id: 'services', label: 'Services', href: '/superadmin/services', icon: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01' },
...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="w-20 h-screen flex-shrink-0 hidden lg:flex flex-col z-50" style={{ backgroundColor: sidebarBg, borderRight: `1px solid ${borderColor}` }}>
        <div className="py-4 px-4 border-b flex-shrink-0" style={{ borderColor }}>
