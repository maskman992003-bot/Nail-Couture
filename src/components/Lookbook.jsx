...
function Lightbox({ item, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-charcoal/95 flex items-center justify-center p-4 md:p-8" onClick={onClose}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="relative">
          ...
          >
            {filteredItems.map((item, index) => (
              <SwiperSlide key={`slide-${index}`} className="!w-[300px] md:!w-[380px] !h-[450px]">
                {({ isActive }) => (
                  <div
