  ...
  return (
    <footer className="bg-charcoal border-t border-gold/30 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
        ...
        <div>
          <h4 className="text-gold text-sm tracking-wider mb-4">OUR GUARANTEE</h4>
          <p className="text-offwhite/60 text-sm leading-relaxed">
        ...
        <div>
          ...
          <div className="space-y-3">
            <a 
              ...
              className="flex items-center gap-2 text-offwhite/60 hover:text-gold transition-colors text-sm"
            >
      ...
      <div className="border-t border-gold/10 py-6 text-center">
        <p className="text-offwhite/40 text-xs tracking-wider">
          © 2026 NAIL COUTURE. ALL RIGHTS RESERVED.
        </p>
      </div>
    </footer>
  );
