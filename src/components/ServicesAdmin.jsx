  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0B0C] text-white transition-all duration-300 pl-0 md:pl-20 lg:pl-64">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pb-24 lg:pb-8">
          ...
          {showAddOnModal && (
            <div className="fixed inset-0 z-[500] flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0,0,0,0.85)' }}>
              <div className="w-full max-w-md rounded-xl p-6 border" style={{ backgroundColor: '#1a1a1a', borderColor: 'rgba(197,160,89,0.3)' }}>
                <h2 className="font-heading text-xl text-gold mb-5">Add New Add-On</h2>
