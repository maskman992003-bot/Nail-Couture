-- Migration 109: delete_nail_assessment RPC
-- Run once in Supabase SQL Editor after 061_assessment_security.sql

CREATE OR REPLACE FUNCTION delete_nail_assessment(
  caller_phone TEXT,
  p_profile_id UUID,
...
COMMENT ON FUNCTION delete_nail_assessment IS
  'Deletes a saved nail assessment for the authenticated profile owner.';

GRANT EXECUTE ON FUNCTION delete_nail_assessment(TEXT, UUID, UUID) TO anon, authenticated;
