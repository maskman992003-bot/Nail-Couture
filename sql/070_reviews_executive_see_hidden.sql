-- Migration 070: Executive roles still see hidden reviews on staff Reviews tab
-- Run once in Supabase SQL Editor after 069_reviews_hide_from_staff_list.sql
-- super_admin, owner, and partner can view hidden reviews; admin/cashier/technician cannot.
