...
function StatCard({ label, value, suffix, icon, footerLink, className = 'flex-1' }) {
  return (
    <div className={`${className} rounded-2xl border border-card bg-card p-4 min-w-0`}>
...
export function PointsBalanceBar({ points }) {
  const formatted = Number(points || 0).toLocaleString();
